...
def main():
    ...
    print("\n📊 Calculating historical ELO ratings (2022-2025)...")
    print("   (Automatically skips unplayed games)")
    elo_df = calculator.calculate_historical_elos(start_year=2022, end_year=2025)
